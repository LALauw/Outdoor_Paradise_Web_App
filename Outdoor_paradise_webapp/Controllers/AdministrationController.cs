...
namespace Outdoor_paradise_webapp.Controllers {
	...
	public class AdministrationController : Controller {
		...
		public AdministrationController(RoleManager<IdentityRole> roleManager, UserManager<AppUser> userManager, DatabaseContext context) {
		...
		public async Task<IActionResult> EditRole(string id) {
			...
			foreach(var user in userManager.Users) {
				if(await userManager.IsInRoleAsync(user, role.Name)) {
					model.Users.Add(user.UserName + " - " + user.Full_name);
				};
			}
			return View(model);
		}
