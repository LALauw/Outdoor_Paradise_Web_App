...
namespace Outdoor_paradise_webapp.Controllers {
	...
	public class CourseController : Controller {
		...
		public async Task<IActionResult> Create([Bind("Id,Description,Name")] Course course) {
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Name")] Course course) {
			if(id != course.Id) {
				return NotFound();
			}
